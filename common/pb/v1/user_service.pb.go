...
// GetUserRequest request user by id
...
// GetUserResponse return user struct
...
const file_user_service_proto_rawDesc = "" +
	"\n" +
	"\x12user_service.proto\x12\x06api.v1\">\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\f.api.v1.UserR\x04user2I\n" +
	"\vUserService\x12:\n" +
	"\aGetUser\x12\x16.api.v1.GetUserRequest\x1a\x17.api.v1.GetUserResponseB\x19Z\x17microservices/common/pbb\x06proto3"
...
var file_user_service_proto_depIdxs = []int32{
	...
	1, // 1: api.v1.UserService.GetUser:input_type -> api.v1.GetUserRequest
	2, // 2: api.v1.UserService.GetUser:output_type -> api.v1.GetUserResponse
